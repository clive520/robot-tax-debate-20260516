...
> 本文件保留作既有集數資料紀錄。今後新增集數需要填哪些欄位與如何上架，請以 `docs/ai-debate-sop.md` 為標準流程。
...
- 反方：Gemini
- 裁判：Claude
- YouTube 標題：`AI辯論所_EP03：我國應將「積極安樂死」合法化`
...
- Podcast 節目頁 URL：`https://open.spotify.com/show/033i8synWg22dgCqwNGCAX`
- Podcast Embed URL：不使用；網站固定連到 Spotify 節目頁
- 備註：2026-05-18 已建立辯論原稿、Podcast 音訊、YouTube SRT、Podcast 影片、YouTube 縮圖與 Podcast 封面。後續需上架 YouTube 與 Spotify，並在上架後回填正式 URL。
